...
function parseTerms(terms) {
	//Split the terms into a 2d array of words and definitions
			...
			<div className="mx-auto my-auto w-3/4 h-3/4">
				<div className="mt-12 space-y-5">
					...
					<div className="mx-auto w-3/4 space-y-5">
						...
						></textarea>
						<button onClick={() => setInput({learnMode: true, terms: parseTerms(inputData.terms)})} href="#" class="inline-flex float-right items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
							Study
